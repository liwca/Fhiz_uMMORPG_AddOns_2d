...
public partial class NetworkManagerMMO
{
    ...
    public void OnStartServer_UCE_WorldEvents()
    {
    ...
    public void OnStopServer_UCE_WorldEvents()
    {
        UCE_SaveWorldEvents();
    }
    ...
    public void OnServerDisconnect_UCE_WorldEvents(NetworkConnection conn)
    {
        UCE_SaveWorldEvents();
    }
