...
public partial struct UCE_Quest
{
    ...
    public string TooltipSnippet_PvpTarget(int level)
    {
        string tmpString = "";
#if _iMMOPVP
    ...
    // -------------------------------------------------------------------------------
    [DevExtMethods("TooltipSnippet")]
    public string TooltipSnippet_KillTarget()
    {
        string tmpString = "";
    ...
    // -------------------------------------------------------------------------------
    [DevExtMethods("TooltipSnippet")]
    public string TooltipSnippet_GatherTarget()
    {
        string tmpString = "";
    ...
    // -------------------------------------------------------------------------------
    [DevExtMethods("TooltipSnippet")]
    public string TooltipSnippet_VisitTarget()
    {
        string tmpString = "";
    ...
    // -------------------------------------------------------------------------------
    [DevExtMethods("TooltipSnippet")]
    public string TooltipSnippet_ExploreTarget(int explored = 0)
    {
        string tmpString = "";
#if _iMMOEXPLORATION
    ...
    // -------------------------------------------------------------------------------
    [DevExtMethods("TooltipSnippet")]
    public string TooltipSnippet_HarvestTarget()
    {
        string tmpString = "";
#if _iMMOHARVESTING
    ...
    // -------------------------------------------------------------------------------
    [DevExtMethods("TooltipSnippet")]
    public string TooltipSnippet_CraftTarget()
    {
        string tmpString = "";
#if _iMMOCRAFTING
    ...
    // -------------------------------------------------------------------------------
    [DevExtMethods("TooltipSnippet")]
    public string TooltipSnippet_LootTarget()
    {
        string tmpString = "";
#if _iMMOCHEST
    ...
    // -------------------------------------------------------------------------------
    [DevExtMethods("TooltipSnippet")]
    public string TooltipSnippet_FactionTarget()
    {
        string tmpString = "";
#if _iMMOFACTIONS
